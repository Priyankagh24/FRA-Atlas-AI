...
import { ArrowRight, Map, Upload, MessageCircle, BarChart, Shield, Users, Brain } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Upload land photos for instant AI-powered classification (Forest, Agriculture, Urban, etc.) to support FRA claims.",
    },
    {
      icon: Map,
            ...
            <div className="animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button asChild size="xl" variant="outline">
                  <Link to="/land-classification">AI Land Classification</Link>
                </Button>
                <Button asChild size="xl" variant="outline">
